...
var BookService = (function () {
    ...
    BookService.prototype.getBooksByParam = function (param) {
        var _this = this;
        this.getData(param).subscribe(function (books) { return _this.books = books; });
        return this.books;
    };
    BookService.prototype.getData = function (param) {
